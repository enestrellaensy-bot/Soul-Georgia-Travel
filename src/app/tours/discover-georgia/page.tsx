...
const itineraryRu = [
  ...
  { day: 3, place: "Мцхета", title: "Древняя столица и грузинское вино", text: "Монумент «Летопись Грузии», монастырь Джвари, Светицховели и знакомство с традиционным виноделием в Iago’s Winery.", note: "Мцхета · Джвари · дегустационный сет", image: "/tour1/tour_3.jpg", position: "80% center" },
...
const detailedProgrammeRu = [
  ...
  {
    day: 3,
    title: "«Летопись Грузии», Мцхета и Iago’s Winery",
    ...
    stops: [
      ...
      ["Iago’s Winery", "Знакомство с традиционным виноделием и винами, созданными по старинной технологии. Дегустация включена."],
    ],
  },
  {
    day: 4,
    ...
    stops: [
      ...
      ["Винодельня Vakirelebi", "Дегустация местных вин, кулинарный мастер-класс и ужин в кахетинской атмосфере. Включено."],
    ],
  },
  {
    day: 5,
